...
let EventSubscribersLoader = class EventSubscribersLoader {
    constructor(discoveryService, eventEmitter, metadataAccessor, metadataScanner, moduleRef, eventEmitterReadinessWatcher, options = {}) {
    ...
    loadEventListeners() {
        ...
        [...providers, ...controllers]
            ...
            this.metadataScanner
                ...
                .forEach(methodKey => this.subscribeToEventIfListener(instance, methodKey, isRequestScoped, wrapper.host));
        });
    }
    ...
    registerRequestScopedListener(eventListenerContext) {
        ...
        listenerMethod(event, async (...args) => {
            ...
            const contextId = this.options.inheritRequestContextId
                ? core_1.ContextIdFactory.getByRequest(request)
                : core_1.ContextIdFactory.getByRequest({
                    payload: request,
                });
...
exports.EventSubscribersLoader = EventSubscribersLoader = __decorate([
    ...
    __param(6, (0, common_1.Inject)(constants_1.EVENT_EMITTER_MODULE_OPTIONS)),
    __metadata("design:paramtypes", [core_1.DiscoveryService,
        eventemitter2_1.EventEmitter2,
        events_metadata_accessor_1.EventsMetadataAccessor,
        core_1.MetadataScanner,
        core_1.ModuleRef,
        event_emitter_readiness_watcher_1.EventEmitterReadinessWatcher, Object])
