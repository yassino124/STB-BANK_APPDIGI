    ...
    create(response, produces, schemas, factories) {
        ...
        if ((0, is_built_in_type_util_1.isBuiltInType)(type)) {
            ...
            const schema = response.nullable
                ...
                : baseSchema;
            const content = this.mimetypeContentWrapper.wrap(produces, Object.assign({ schema }, (0, lodash_1.pick)(response, exampleKeys)));
            return Object.assign(Object.assign({}, (0, lodash_1.omit)(response, [...exampleKeys, 'nullable'])), content);
        }
