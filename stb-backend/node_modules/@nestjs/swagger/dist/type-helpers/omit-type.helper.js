...
function OmitType(classRef, keys) {
    ...
    (0, mapped_types_utils_1.setMappedTypeClassName)(OmitTypeClass, 'Omit', classRef, keys);
    ...
    function applyFields(fields) {
        ...
        if (OmitTypeClass[plugin_constants_1.METADATA_FACTORY_NAME]) {
            const pluginMetadata = OmitTypeClass[plugin_constants_1.METADATA_FACTORY_NAME]();
            Object.keys(pluginMetadata).forEach((key) => {
                if (!fields.includes(key)) {
                    const decoratorFactory = (0, decorators_1.ApiProperty)(pluginMetadata[key]);
