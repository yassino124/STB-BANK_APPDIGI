...
function PickType(classRef, keys) {
    ...
    (0, mapped_types_utils_1.setMappedTypeClassName)(PickTypeClass, 'Pick', classRef, keys);
    ...
    function applyFields(fields) {
        ...
        if (PickTypeClass[plugin_constants_1.METADATA_FACTORY_NAME]) {
            const pluginMetadata = PickTypeClass[plugin_constants_1.METADATA_FACTORY_NAME]();
