...
function PartialType(classRef, options = {}) {
    ...
    (0, mapped_types_utils_1.setMappedTypeClassName)(PartialTypeClass, 'Partial', classRef);
    ...
    function applyFields(fields) {
        ...
        if (PartialTypeClass[plugin_constants_1.METADATA_FACTORY_NAME]) {
            const pluginMetadata = PartialTypeClass[plugin_constants_1.METADATA_FACTORY_NAME]();
            const pluginFields = Object.keys(pluginMetadata);
            pluginFields.forEach((key) => {
                if (!fields.includes(key)) {
                    const decoratorFactory = (0, decorators_1.ApiProperty)(Object.assign(Object.assign({}, pluginMetadata[key]), { required: false }));
                    decoratorFactory(PartialTypeClass.prototype, key);
                }
                applyPartialDecoratorFn(PartialTypeClass, key);
            });
