...
export declare class ControllerClassVisitor extends AbstractFileVisitor {
    ...
    createApiParamDecorators(factory: ts.NodeFactory, node: ts.MethodDeclaration, methodDecorators: readonly ts.Decorator[], typeChecker: ts.TypeChecker): ts.Decorator[];
