...
const apply_example_max_depth_util_1 = require("./utils/apply-example-max-depth.util");
const get_global_prefix_1 = require("./utils/get-global-prefix");
const strip_dynamic_defaults_util_1 = require("./utils/strip-dynamic-defaults.util");
...
class SwaggerScanner {
    ...
    scanApplication(app, options) {
        const { deepScanRoutes, include: includedModules = [], extraModels = [], ignoreGlobalPrefix = false, operationIdFactory, linkNameFactory, autoTagControllers = true, onlyIncludeDecoratedEndpoints = false, excludeDynamicDefaults = false, exampleMaxDepth } = options;
        ...
        if (excludeDynamicDefaults) {
            (0, strip_dynamic_defaults_util_1.stripDynamicDefaults)(schemas);
        }
        (0, apply_example_max_depth_util_1.applyExampleMaxDepth)(schemas, exampleMaxDepth);
