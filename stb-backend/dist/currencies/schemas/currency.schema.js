...
__decorate([
    (0, mongoose_1.Prop)({ required: true, unique: true, index: true, uppercase: true, length: 3 }),
...
__decorate([
    (0, mongoose_1.Prop)({ default: 2, min: 0, max: 4 }),
...
exports.Currency = Currency = __decorate([
    (0, mongoose_1.Schema)({ timestamps: true, collection: 'currencies' })
], Currency);
