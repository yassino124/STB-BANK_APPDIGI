...
let DashboardService = class DashboardService {
    ...
    notifModel;
    txModel;
    constructor(empModel, accountModel, cardModel, creditModel, leaveBalanceModel, primeModel, payrollModel, notifModel, txModel) {
...
exports.DashboardService = DashboardService = __decorate([
    ...
    __param(5, (0, mongoose_1.InjectModel)(prime_schema_1.Prime.name)),
    __param(6, (0, mongoose_1.InjectModel)(payroll_schema_1.Payroll.name)),
    __param(7, (0, mongoose_1.InjectModel)(notification_schema_1.Notification.name)),
    __param(8, (0, mongoose_1.InjectModel)(transaction_schema_1.Transaction.name)),
